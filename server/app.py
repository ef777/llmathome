#!/usr/bin/env python3
# app.py - Kodlama Asistanı Flask + WebSocket Server
# Ubuntu sunucuda çalışacak komple server
...
def run_websocket_server():
    ...
    # Asyncio event loop oluştur ve çalıştır
    try:
        loop = asyncio.new_event_loop()
        asyncio.set_event_loop(loop)
        loop.run_until_complete(start_server())
    except Exception as e:
        logger.error(f"❌ WebSocket server hatası: {e}")
...
💡 İpucu: Ctrl+Enter ile hızlı gönderim"></textarea>
        ...
        <div class="footer">
            <p>Made with ❤️ for developers • Powered by your GTX 1050 Ti • DeepSeek Coder AI</p>
        </div>
    </div>
    ...
    <script>
        class CodeAssistant {
            ...
            showWelcomeMessage() {
                ...
                welcomeDiv.innerHTML = `
                    ...
                    <div style="color: #059669;">
                        <p>✅ Ev makinesine başarıyla bağlandım!</p>
                        <p>🤖 DeepSeek Coder 6.7B modeli hazır</p>
                        <p>⚡ Artık kodlama sorularınızı sorabilirsiniz</p>
                    </div>
                `;
                ...
                // Auto-remove welcome message after 5 seconds
                setTimeout(() => {
            ...
            showConnectionError() {
                ...
                errorDiv.innerHTML = `
                    ...
                    <div style="color: #dc2626;">
                        <p><strong>Sunucuya bağlanamadım!</strong></p>
                        <p style="margin-top: 10px;">🔧 <strong>Kontrol edilecekler:</strong></p>
                        <ul style="margin-left: 20px; margin-top: 5px;">
                            <li>Ev makinesindeki client çalışıyor mu?</li>
                            <li>Sunucu servisleri aktif mi?</li>
            ...
            sendPrompt() {
                ...
                if (!this.isConnected) {
                    this.showError('🔴 Sunucuya bağlı değilsiniz. Lütfen bağlantıyı kontrol edin.');
                    return;
                }
            ...
            showLoading(requestId) {
                ...
                loadingDiv.innerHTML = `
                    ...
                    <div style="display: flex; align-items: center; gap: 12px; color: #6b7280;">
                        ...
                        <div>
                            <p>Ev makinesindeki GTX 1050 Ti'den yanıt bekleniyor...</p>
                            <p style="font-size: 0.9rem; margin-top: 5px; color: #9ca3af;">
                                ⏱️ Ortalama yanıt süresi: 15-30 saniye
                            </p>
                        </div>
                    </div>
                `;
            ...
            showError(message) {
                ...
                errorDiv.innerHTML = `
                    ...
                    <div style="font-size: 0.9rem; color: #6b7280;">
                        ...
                        • Ollama servisinin aktif olduğunu kontrol edin<br>
...
@app.route('/')
def index():
    """Ana sayfa - HTML template döndür"""
...
def main():
    ...
    logger.info("🚀 Kodlama Asistanı Server başlatılıyor...")
